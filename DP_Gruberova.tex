...
\includepdf{prohlaseni-AR.pdf} % NAHRAĎTE správným souborem!!!!DOPLNIT
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item test\_utils.py
  \end{itemize}
  \item run\_analysis.ipynb -- Jupyter Notebook pro spuštění analýzy.
  \item requirementstxt -- soubor s potřebnými knihovnami jazyka Python.
  \item \_\_init\_\_.py
\end{itemize}
