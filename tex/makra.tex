...
\newcommand{\autor}{Bc. Anna Gruberová}   % vyplňte své jméno a příjmení (s akademickým titulem, máte-li jej)
...
\newcommand{\podekovani}{Chtěla bych poděkovat Ing. Václavu Máchovi za vedení mé bakalářské práce, za cenné rady a připomínky k tvorbě této práce a za čas strávený touto pomocí.} % NAPIŠTE poděkování, např. svému vedoucímu:
