...
\newcommand{\abstrCZ}{
Tato diplomová práce analyzuje příčiny vzniku shrinků a navrhuje univerzální postup pro ohodnocení produktů z hlediska náchylnosti produktů ke shrinku. Na základě provedené analýzy je navržen obecný postup ke snížení shrinků, aplikovatelný i na data jiných společností. Práce se věnuje teoretickému základu logistiky, druhům plýtvání a definici a dělení shrinku. Praktická část obsahuje výběr a přípravu vzorku a tvorbu interaktivního reportu. Provedené analýzy umožňují formulovat a ověřit hypotézy pomocí metody 4ftMiner. Pomocí korelační analýzy jsou produkty rozdělené do kategorií vzhledem k povaze shrinku. Tato kategorizace je implementována v jazyce Python. Prostřednictvím tohoto postupu mohou  společnosti ohodnotit své produktové portofolio a snížit tak objem svých odepisovaných produktů a minimalizovat z~ toho plynoucí ztracené náklady.
}
