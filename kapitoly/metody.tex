...
Pro vizualizaci dat jsem použila nástroj Power BI Desktop, dále už jen Power BI. Tato aplikace umožňuje vytvořit business intelligence report pro sledovaná data.

Power BI pro práci s daty využívá dva jazyky -- jazyk M a jazyk DAX. První jmenovaný lze použít při nahrávání dat a jejich zpracování, pro běžnou práci není nutné tento jazyk přímo psát, jelikož se generuje na základě kroků v GUI aplikace. Druhý jmenovaný se používá přímo ve vizualizační části. 

TODO
\subsubsection*{Metriky}
