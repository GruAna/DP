...
Nejčastěji používaným koeficientem pro měření korelace je Pearsonův korelační koeficient. Nechť $X$ a $Y$ jsou náhodné veličiny s realizacemi $x_1, x_2, \ldots$ a $y_1, y_2, \ldots$, potom hodnota Pearsonova koeficientu se vypočítá jako:
\begin{equation}
