...
První část této kapitoly se věnuje teoretickému popisu použitých metod v~této práci. Nejprve jsou uvedené vybrané metody pro redukci dimenzionality, poté způsoby měření závislosti. Další část se věnuje metodě GUHA. Zbytek kapitoly se týká nástrojů, které jsem používala při tvorbě této diplomové práce.
% korelace
% ortogonální
...
Tato část se věnuje popisu použitého softwaru, a to především popisu  nástroje Microsoft Power BI pro vytváření interaktivních reportů.
