...
Jirsák \cite{bib:Jirsak} rozlišuje plýtvání v podobě Mura jak při informačním, tak hmotném toku. V případě informačního toku je nejvýznamnějším zdrojem plýtvání situace, 
