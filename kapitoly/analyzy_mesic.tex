\chapter{Příprava vzorku dat pro další analýzy}
...
\begin{figure}[hbtp!]
    ...
    \caption{Zastoupení shrinků typu damage a zastoupení kategorie 1 v datech \\ z března roku 2023.}
...
Dále jsem se zabývala identifikací odlehlých hodnot. Nejprve jsem vizualizovala hodnoty pomocí grafu, obrázky \ref*{obr:rok:g:outlierN} a \ref*{obr:rok:g:outlierO}. Z grafu je patrné, že problémová je proměnná \texttt{warehouse\_id}, která označuje ID prodejny. Prodejny, které tvoří outliery mohou být malé prodejny, které kvůli menšímu počtu celkových produktů neevidují větší počet shrinků. % !!! TODO jakeho grafu 
...
Dále jsem použila výpočet koeficientů vzájemné informace\footnote{\emph{mutual information}}, který říká, jaká je podobnost mezi dvěma proměnnými \cite{bib:scikit}. % !!! odkaz na teorii TODO
...
% TODO!!! dopsat co to je %!!!zdroj, odkaz na teorii TBD
