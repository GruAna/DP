...
Na základě předchozích metod jsem se rozhodla zredukovat původní příznaky datasetu na jejich výběr. Vzhledem k tomu, že různé metody vybraly různé příznaky, jsou stanoveny dvě podmnožiny původních příznaků. 
...
\begin{table}[hbtp!]
    ...
    Metoda                          & Přesnost \linebreak (trénovací data) & Přesnost \linebreak (testovací data) \\ \hline
...
V případě random forest klasifikátoru se jedná o parametry 
