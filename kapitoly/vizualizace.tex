...
\begin{figure}[h!]
    ...
    \caption{Power BI report -- Zastoupení kategorií 3. a4. úrovně na celkových tržbách  \\ ve sledovaném období.}
...
Typ shrinku          & \vtop{\hbox{\strut Hodnota}\hbox{\strut shrinku}}  & \vtop{\hbox{\strut Počet}\hbox{\strut záznamů}}  &  \vtop{\hbox{\strut Průměrný podíl }\hbox{\strut na  tržbách}\hbox{\strut  produktů [\%]}} & \vtop{\hbox{\strut Podíl na }\hbox{\strut celkových}\hbox{\strut  tržbách [\%]}}& \vtop{\hbox{\strut Hodnota }\hbox{\strut shrinku [\%]}}  \\ 
\midrule
...
\begin{figure}[hbtp!]
    ...
    \begin{minipage}{.5\textwidth}
        \centering
        \captionsetup{justification=centering}
        \includegraphics[width=0.5\textwidth]{obrazky/PBI/vsLoc.png}
...
Největší ztracené náklady byly evidovány u velké prodejny s ID 198 v Praze, nicméně podíl tohoto shrinku na celkových tržbách je pouhých $0{,}23 \%$, což je jeden z nejnižších. Zároveň se jedná o prodejnu s nejvyššími tržbami. Zatímco prodejna 675 velká prodejna v okrese Uherské Hradiště má třetí nejvyšší hodnotu shrinku a zároveň i nejvyšší podíl shrinku na tržbách $1{,}68 \%$ mezi velkými prodejnami. 
...
Z grafu je patrné, že čtyři malé prodejny mají podobné tržby jako velké prodejny. Jedná se o dvě prodejny v Praze a prodejny v okrese Litoměřice a Jablonec nad Nisou, tyto pražské prodejny mají vyšší podíl shrinku než zbylé dvě prodejny.
