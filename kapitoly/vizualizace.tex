...
Power BI nabízí uživatelům reportu širokou interakci s~vizuály. Díky metrikám se zobrazené hodnoty přepočítávají podle aktuálních filtrů nebo podle vybraných dat. Dále je popsán význam vybraných metrik.

\begin{itemize}
    \itemsep-0.3em
    \item     \textbf{Lost Cost} -- Základní metrika s~hodnotou shrinku ze vstupních dat.
    \item     \textbf{Lost Cost Normalized} -- Průměrná výše shrinku na jednu prodejnu.
    ...
    \item     \textbf{Share on Store Revenue} -- Průměrný podíl shrinku na průměrných celkových tržbách prodejny.
    \item     \textbf{Revenue of Stores} -- Celková tržba prodejny za celé sledované období.
    \item     \textbf{Revenue of Stores Normalized} -- Průměrná celková tržba prodejny za sledované období.
...
V následující části jsou popsány jednotlivé stránky interaktivního reportu vytvoře-\\ného v~softwaru MS Power BI.
