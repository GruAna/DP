...
Nejprve jsem se zaměřila na kategorie úrovně 4, a to prvních deset kategorií s nejvyšší hodnotou shrinků (tj. s nejvyšší zaznamenanou ztrátou) 


V tabulce č. \ref*{tab:MEATCorrPorovnani} je porovnání výsledků kategorizace pro kategorii Masné výrobky (úroveň 4).
\begin{table}[hbtp!]
    \centering
    \captionsetup{justification=centering}
    \caption{Tabulka kategorizace - Kategorie Masné výrobky (úroveň 4).}
    \begin{tabular}{l *{6}{r}}
    \multicolumn{1}{l}{} & \multicolumn{2}{p{3.5cm}}{Korelace s~tržbami ostatních produktů} & \multicolumn{2}{p{3.9cm}}{Korelace s tržbami ostatních produktů v~promoakci}  & \multicolumn{2}{p{3.9cm}}{Korelace s~tržbami ostatních produktů v~a po promoakci} \\
    Kategorie & Stejný den & Další den & Stejný den & Další den & Stejný den & Další den \\
    \hline
    \multicolumn{7}{c}{Pearsonův korelační koeficient} \\
    \hline
    ...
    Nevýzn.     & 9     & 9   & 9   & 9   & 9   & 9   \\
    \hline
    \multicolumn{7}{c}{Spearmanův korelační koeficient} \\
    \hline
    P           & 96   & 96   & 96   & 96   & 96   & 96   \\
    O           & 1     & 1   & 2   & 2   & 2   & 2   \\
    X           & 3     & 3   & 2   & 2   & 2   & 2   \\
    ...
    \end{tabular}
    \label{tab:MEATCorrPorovnani}
\end{table}

V tabulce č. \ref*{tab:SaltyCorrPorovnani} je porovnání výsledků kategorizace pro kategorii Masné výrobky (úroveň hierarchie 4)

\begin{table}[hbtp!]
    \centering
    \captionsetup{justification=centering}
    \caption{Tabulka kategorizace - Kategorie Masné výrobky - pultový prodej (úroveň 4).}
    \begin{tabular}{l *{6}{r}}
    \multicolumn{1}{l}{} & \multicolumn{2}{p{3.5cm}}{Korelace s~tržbami ostatních produktů} & \multicolumn{2}{p{3.9cm}}{Korelace s tržbami ostatních produktů v~promoakci}  & \multicolumn{2}{p{3.9cm}}{Korelace s~tržbami ostatních produktů v~a po promoakci} \\
    Kategorie & Stejný den & Další den & Stejný den & Další den & Stejný den & Další den \\
    \hline
    \multicolumn{7}{c}{Pearsonův korelační koeficient} \\
    \hline
    P           & 130   & 130   & 130   & 130   & 130   & 130   \\
    O           & 3     & 5   & 16   & 16   & 16   & 16   \\
    X           & 13    & 11   & 0    & 0    & 0    & 0    \\
    Nevýzn.     & 100   & 100  & 100  & 100  & 100  & 100  \\
    \hline
    \multicolumn{7}{c}{Spearmanův korelační koeficient} \\
    \hline
    ...
    \end{tabular}
    \label{tab:SaltyCorrPorovnani}
\end{table}

Z uvedených tabulek \emph{(TBD: Bude jich víc.)}


\textbf{Masné výrobky - pultový prodej}

Produkty, které patří do kategorie O: Velikonoční klobása a Velikonoční česnekový šál - jedná se o zcela jistě o sezónní výrobky. \emph{TBD: vyjmenovat i další produkty, keré si způsobují samy, ale je to většina produktů a salámy, šunky, z kategorie...} 
...
PLETÝNKA ADÉLKA 
PLETÝNKA MALENA 
PLETÝNKA SYPANÁ MÁKEM 
PLETÝNKA SYPANÁ SOLÍ A KM.
BRAMBOROVÉ PEČIVO S CIBULÍ
VEKA CUPEKO KB 
ROHLÍK GRAHAMOVÝ ASPEC
ROHLÍK PIVNÍ ORA
ROHLÍK STAROČESKÝ
ROHLÍK OBILNÝ MAM
ROHLÍK NA STROUH.KARLOVA B
ROHL.N STR.PENAM MARTINOVB
HOUSKA MAŠEK
*HOUSKA RAŽENKA
BAGETA RUST.POH.
BAGETA S GRAHAMEM MALENA
BAGETA CHLEBOVÁ 
BANKETKA CEREÁLNÍ
DALAMÁNEK CUPEKO 
KOSTKA CEREÁL MALENA
CIABATTA MINI NATURAL
TWISTR SE SÝREM A ŠPENATEM
ANGLICKÝ ROHLÍK 

\emph{Nevidím pravidlo v tom, co je v produktech, kterým shrink způsobují ostatní produkty, a které si za to mohou samy. TBD: názvy zobecním...}

\textbf{Sladké pečivo}

\textbf{Ovoce a zelenina}
