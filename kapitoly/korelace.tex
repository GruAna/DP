...
\begin{itemize}
    ...
    \item Propojení dat
    \item Korelace (Pearsonův, Spearmanův korelační koeficient) (oveření předpokladů, testování statistické významnosti)
    \item Kategorizace
    \item Pomocné funkce
\end{itemize}

\section{Výsledky}
Zvolila jsem 5\% hladinu významnosti pro testování statistické významnosti.

\begin{table}[hbtp!]
    \centering
    \captionsetup{justification=centering}
    \caption{Tabulka kategorizace - Pearsonův korelační koeficient.}
    \begin{tabular}{r rr rr rr}
        \multicolumn{1}{l}{} & \multicolumn{6}{c}{Korelace s tržbami}  \\
    \multicolumn{1}{l}{} & \multicolumn{2}{p{3.5cm}}{ostatních produktů} & \multicolumn{2}{p{3.9cm}}{ostatních produktů v promoakci}  & \multicolumn{2}{p{3.9cm}}{ostatních produktů v a po promoakci} \\
...
Nejprve jsem se zaměřila na kategorie úrovně L4, a to prvních 
